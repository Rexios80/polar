...
Object? _readEntryId(Map<dynamic, dynamic> json, String key) =>
...
Object? _readInterval(Map<dynamic, dynamic> json, String key) =>
    readPlatformValue(json, {
      TargetPlatform.iOS: 'interval',
      TargetPlatform.android: 'recordingInterval',
    });

Object? _readSamples(Map<dynamic, dynamic> json, String key) =>
    readPlatformValue(json, {
