...
) => <String, dynamic>{'samples': instance.samples.map(toJsonT).toList()};
...
PolarEcgSample _$PolarEcgSampleFromJson(Map<String, dynamic> json) =>
    PolarEcgSample(
      timeStamp: const PolarSampleTimestampConverter().fromJson(
        (json['timeStamp'] as num).toInt(),
      ),
      voltage: (json['voltage'] as num).toInt(),
    );

Map<String, dynamic> _$PolarEcgSampleToJson(
  PolarEcgSample instance,
) => <String, dynamic>{
...
Map<String, dynamic> _$PolarAccSampleToJson(
  PolarAccSample instance,
) => <String, dynamic>{
  'timeStamp': const PolarSampleTimestampConverter().toJson(instance.timeStamp),
  'x': instance.x,
  'y': instance.y,
...
Map<String, dynamic> _$PolarGyroSampleToJson(
  PolarGyroSample instance,
) => <String, dynamic>{
  'timeStamp': const PolarSampleTimestampConverter().toJson(instance.timeStamp),
  'x': instance.x,
  'y': instance.y,
...
PolarPpiSample _$PolarPpiSampleFromJson(Map<String, dynamic> json) =>
    PolarPpiSample(
      ...
      skinContactStatus: const PlatformBooleanConverter().fromJson(
        json['skinContactStatus'],
      ),
      skinContactSupported: const PlatformBooleanConverter().fromJson(
        json['skinContactSupported'],
      ),
    );

Map<String, dynamic> _$PolarPpiSampleToJson(
  PolarPpiSample instance,
) => <String, dynamic>{
  'timeStamp': instance.timeStamp,
  'ppi': instance.ppi,
  'errorEstimate': instance.errorEstimate,
  'hr': instance.hr,
  'blockerBit': const PlatformBooleanConverter().toJson(instance.blockerBit),
  'skinContactStatus': const PlatformBooleanConverter().toJson(
    instance.skinContactStatus,
  ),
  'skinContactSupported': const PlatformBooleanConverter().toJson(
    instance.skinContactSupported,
  ),
};
...
PolarLocationDataSample _$PolarLocationDataSampleFromJson(
  ...
  accelerationSpeedFactor: (json['accelerationSpeedFactor'] as num).toDouble(),
